...
class IOSDecompressTest {
    ...
    fun decompress_whenGivenTwoByteBase64_shouldReturnExpectedByteArray() = runTest {
        ...
        assertContentEquals(compressedData, byteArrayOf(0xb9.toByte(), 0xa3.toByte()))
    }
    ...
    fun decompress_whenGivenThreeByteBase64_shouldReturnExpectedByteArray() = runTest {
        ...
        // Verify the decompressed data matches the original
        assertContentEquals(compressedData, byteArrayOf(0xc9.toByte(), 0x44.toByte(), 0xf9.toByte()))
    }
}
